...
- If it is a `.dmg` file: double-click it to open a window where you can drag the MenuPiP app to your Applications folder.  
- If it is a `.zip` file: double-click to unzip it, then move the MenuPiP app to your Applications folder.
...
3. Check the box next to MenuPiP.  
4. Restart MenuPiP to apply the permission.
